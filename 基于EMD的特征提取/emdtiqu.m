...
xlswrite('E:\毕业课题\我的进展\课题的改进算法研究\EMD和改进EMD的分类结果对比\基于EMD的特征提取\正常数据',pe)
%% 对内圈故障数据进行eemd
...
xlswrite('E:\毕业课题\我的进展\课题的改进算法研究\EMD和改进EMD的分类结果对比\基于EMD的特征提取\内圈故障',pe1)
%% 对内圈故障数据进行eemd
...
xlswrite('E:\毕业课题\我的进展\课题的改进算法研究\EMD和改进EMD的分类结果对比\基于EMD的特征提取\外圈故障',pe2)
%% 对滚珠故障数据进行eemd
...
xlswrite('E:\毕业课题\我的进展\课题的改进算法研究\EMD和改进EMD的分类结果对比\基于EMD的特征提取\滚珠故障',pe3)
toc
